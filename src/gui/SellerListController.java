...
public class SellerListController implements Initializable, DataChangeListener {
	...
	private void initializeNodes() {
		...
		tableColumnName.setCellValueFactory(new PropertyValueFactory<>("name")); // o nome tem que ser igual ao da
																					// classe
		tableColumnEmail.setCellValueFactory(new PropertyValueFactory<>("email"));
		tableColumnBirthDate.setCellValueFactory(new PropertyValueFactory<>("birthDate"));
		Utils.formatTableColumnDate(tableColumnBirthDate, "dd/MM/yyyy"); // formata data da lista
	...
	private void createDialogForm(Seller obj, String absoluteName, Stage parentStage) {
		try {
			...
			controller.setSeller(obj); // injetar a dependencia da classe do objeto
			controller.setServices(new SellerService() , new DepartmentService());
			controller.loadAssociatedObjects(); // inicializa comboBox de departments
	...
	// Incluir um botão de exclusão "remove" em cada linha da tabela
